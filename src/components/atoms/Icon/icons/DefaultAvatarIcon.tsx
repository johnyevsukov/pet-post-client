...
export const DefaultAvatarIcon: React.FC = () => {
  return (
    <svg id="emoji" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="skin-shadow" />
      <g id="line">
        <circle cx="27.8144" cy="32.0855" r="3" fill="#333333" stroke="none" />
        <circle cx="44.4394" cy="32.0855" r="3" fill="#333333" stroke="none" />
        <path
          fill="none"
          stroke="#333333"
